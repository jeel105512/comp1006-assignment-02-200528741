    ...
    <body class="container">
        ...
        <form action="./create.php" method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" placeholder="Pokemon Card">
            </div>

            <div class="mb-3">
                <label for="description" class="form-label">Description</label>
                <input type="text" class="form-control" name="description" placeholder="This card is of a rare Charizard pokemon...">
            </div>

            <div class="mb-3">
                <label for="value" class="form-label">Collection Value ($)</label>
                <input type="text" class="form-control" name="value" placeholder="100000">
            </div>
            
            <div class="mb-3">
                <label for="signature_by" class="form-label">Collection Signed By</label>
                <input type="text" class="form-control" name="signature_by" placeholder="Ash">
            </div>
